...
SetPrivateProfileString('Keymap Action','Trap Detection','100')
SetPrivateProfileString('Keymap Action','Stealth','102')
SetPrivateProfileString('Keymap Action','Cast Spell','115')
SetPrivateProfileString('Keymap Action','Thieving','103')
